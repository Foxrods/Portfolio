    ...
    return (
        <section className={styles.main}>
            ...
            <div className={styles.lines}>
                <ProjectIcon
                    src={airport}
                    alt={"airport luggage cars monitoring"}
                    onClick={() => setModal(<ProjectModal
                        src={airport}
                        title="Fraport Luggage Cars Monitoring System - Otrack"
                        text="In this project using Angular, I developed from the very beginning the Front-end for a 
                        new Backoffice system for Fraport, where Administrators and Operators can manage 
                        and check in real time data about the cars that transport passengers' luggage to 
                        the planes, in addition to using Artificial Intelligence to obtain this data 
                        through cameras previously installed inside the airport's parking lots."
